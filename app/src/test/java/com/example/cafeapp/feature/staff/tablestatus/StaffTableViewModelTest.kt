...
class StaffTableViewModelTest {
    ...
    private lateinit var viewModel: StaffTableViewModel
    ...
    fun setup() {
        ...
        viewModel = StaffTableViewModel(application)
    ...
    fun fetchTables_whenApiFailed_shouldSetError() = runTest {
        ...
        val result =
            viewModel.tables.value as Resource.Error
